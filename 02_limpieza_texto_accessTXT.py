...
# --- CONFIGURACIÓN ---
nombre_archivo = '1984.txt'

# --- CORPUS Y STOPWORDS ---
# Leer el corpus desde un archivo de texto
def leer_corpus_desde_archivo(file_path):
    """Lee el corpus desde un archivo de texto donde cada línea es una frase."""
    try:
...
print("Ahora podemos ver los términos clave de la narrativa histórica de Los Miserables.")